    ...
    <div class="container">
        ...
        <div class="row my-2">
            <div class="col-md">
                ...
                <a href="export.php" target="_blank" class="btn btn-success ms-1"><i class="bi bi-file-earmark-spreadsheet-fill"></i>&nbsp;Eksport ke Excel</a>
            </div>
        </div>
        <div class="row my-3">
            <div class="col-md">
                        ...
                        <?php foreach ($ruang as $row) : ?>
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="ubah.php?idruang=<?= $row['idruang']; ?>" class="btn btn-warning btn-sm" style="font-weight: 600;"><i class="bi bi-pencil-square"></i>&nbsp;Ubah</a> |

                                    <a href="hapus.php?idruang=<?= $row['idruang']; ?>" class="btn btn-danger btn-sm" style="font-weight: 600;" onclick="return confirm('Apakah anda yakin ingin menghapus data <?= $row['nama']; ?> ?');"><i class="bi bi-trash-fill"></i>&nbsp;Hapus</a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
